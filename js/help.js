    ...
    "portfolio-scout": {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "The status line after a scrape names the path the extractor took:<ul><li><code>haiku_html</code> — content-bearing static HTML, parsed by Claude Haiku. The modal path.</li><li><code>haiku_html_headless</code> — page was a JavaScript shell; rendered via ScrapingAnt's headless browser, then parsed by Haiku. Unlocks Cousins, JBG Smith, Greystar-style React SPAs. Costs 10 ScrapingAnt credits per call.</li><li><code>haiku_html_cloudflare_bypass</code> — Cloudflare bot challenge blocked the static fetch; routed through ScrapingAnt with a residential proxy to bypass, then parsed by Haiku. Costs 25 ScrapingAnt credits.</li><li><code>sitemap</code> — the page was a JavaScript shell; candidate URLs recovered from <code>sitemap.xml</code>. No headless cost.</li><li><code>jsonld</code> — page exposed structured <code>RealEstateListing</code> schema. Rare. Cleanest when it happens.</li></ul>"
        },
        {
